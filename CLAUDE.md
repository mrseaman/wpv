...
- **Training**: MSE + spectral loss (λ=0.1, L1 on log-magnitude FFT), ReduceLROnPlateau scheduler (factor=0.5, patience=5, min_lr=1e-6), AdamW (lr=3e-4), early stopping (patience=20)
